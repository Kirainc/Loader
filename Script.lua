...
_G.Fruit = {
    ["Select Main Fruits"] = {"Kitsune-Kitsune","Leopard-Leopard","Dragon-Dragon","Venom-Venom","Dough-Dough","Soul-Soul"},
    ["Buy Main Fruits"] = true,
    ["Random Fruits"] = true,
    ["Select Fruit Type"] = "Bring Fruits", -- "Tween Fruits" "Bring Fruits"
    ["Bring Fruits"] = true,
}

_G.Shop = {
    -- Shop Settings
    ["Buy Common Item"] = true,
    ["Buy Ability Haki"] = true,
    ["Buy Enchanment Haki"] = true,
...
_G.Quest = {
    ...
    -- Second Sea
    ["Bartilo Quest"] = true,
    ["Death Step Room"] = true,
    ["Evolution Race"] = true,
    ["Third Sea Quest"] = true,
    -- Third Sea
    ["Rainbow Haki"] = true,
    ["Musketeer Hat"] = true,
    ["Special Dungeon"] = true,
    ["Mirror Fractial"] = true,
}
...
if _G.Setting["Disable 3D Rendering"] == true then
    game:GetService("RunService"):Set3dRenderingEnabled(false)
elseif _G.Setting["Disable 3D Rendering"] == false then
...
spawn(function()
    while wait(5) do
        if _G.RedeemCode then
            CheckLevel = game.Players.localPlayer.Data.Level.value
            if CheckLevel >= _G.Setting["Redeem Code At Level"] - 1 then
...
-- Kaitun Capcut Screen

spawn(function()
    while wait() do
        pcall(function()
            if _G.Setting["Kaitun Capcut Screen"] then
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.Shop["Buy Common Item"] then
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.Shop["Buy Ability Haki"] then
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.Shop["Buy Enchanment Haki"] then
                local args = {
                    [1] = "ColorsDealer",
                    [2] = "2"
                }
...
spawn(function()
	while wait() do
		if _G.Shop["Buy Legendary Sword"] then
			local args = {
...
_G.Auto_Upgrade_Stats = true

_G.Point = 6

task.spawn(function()
	while wait() do
		if _G.Auto_Upgrade_Stats then
...
_G.FastAttackDelay = "Super Fast Attack"
        ...
        pcall(function()
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.Setting["Start Farm"] and StartMagnet and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                    ...
                    elseif _G.Setting["Start Farm"] and StartMagnet and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
        ...
        pcall(function()
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.Quest["Evolution Race"] and EvoRace_Magnet then
                    ...
                    if _G.SkipFarmLevel and ShandaMagnet then
                    ...
                    if _G.Fast_Royal_Squad and RoyalMagnet then
                        if (v.Name == "Royal Squad" or v.Name == "Royal Squad") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.Fast_Royal_Soldier and SoldierMagnet then
                        if (v.Name == "Royal Soldier" or v.Name == "Royal Soldier") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
    ...
    while task.wait() do
        pcall(function()
            if _G.BringMonster then
                CheckQuest()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.Setting["Start Farm"] and StartMagnet and v.Name == Mon and (Mon == "Factory Staff [Lv. 800]" or Mon == "Monkey [Lv. 14]" or Mon == "Dragon Crew Warrior [Lv. 1575]" or Mon == "Dragon Crew Archer [Lv. 1600]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                        ...
                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                    elseif _G.Setting["Start Farm"] and StartMagnet and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 275 then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
    ...
    while task.wait() do
        if _G.BringMonster then
            pcall(function()
                ...
                if _G.AutoRengoku and RengokuManget then
                ...
                if _G.SweetThief and SweetThiefBring then
...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 375 or MyLevel <= 399 then
            ...
            if _G.Setting["Start Farm"] and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter or _G.Item["Saber"] or _G.AutoDungeon or _G.AutoKatakuri or _G.Quest["Second Sea "] or _G.Quest["Evolution Race"] == true then
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter or _G.Item["Saber"] or _G.AutoDungeon or _G.AutoKatakuri or _G.Quest["Second Sea"] or _G.Quest["Evolution Race"] then
...
spawn(function()
    while wait(.1) do
        if Choose_Type == 1 then
            Player_Hunter = CFrame.new(0,25,0)
        elseif Choose_Type == 2 then
            Player_Hunter = CFrame.new(0,0,-25)
        elseif Choose_Type == 3 then
            Player_Hunter = CFrame.new(25,0,0)
        elseif Choose_Type == 4 then
            Player_Hunter = CFrame.new(0,0,25)	
        elseif Choose_Type == 5 then
            Player_Hunter = CFrame.new(-25,0,0)
        end
    end
end)
        ...
        if _G.Setting["Start Farm"] then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    StartMagnet = false
                    CheckQuest()
                    if _G.Setting["Bypass Teleport"] then
                                ...
                                if v.Name == Mon then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                        repeat task.wait()
                                            ...
                                            game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until not _G.Setting["Start Farm"] or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        StartMagnet = false
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                    end
                ...
                for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
                        repeat wait()
                            ...
                            EquipWeapon(_G.SelectWeapon)
                            Click()
                            HunterTween(v.HumanoidRootPart.CFrame * Player_Hunter)								
                            v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                            game:GetService'VirtualUser':CaptureController()
                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
...
spawn(function()
    while task.wait() do
        if _G.Fighting["SuperHuman"] then
            pcall(function()
                if game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
                    ...
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") then
                        ...
                        if game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 300 and game:GetService("Players")["Localplayer"].Data.Fragments.Value >= 1500 then
                            ...
                            local Check_Fragment = game:GetService("Players")["Localplayer"].Data.Fragments.Value
                            if Check_Fragment <= 1500 then
                                _G.Fighting["SuperHuman"] = true
                                _G.Setting["Start Farm"] = true
                            else
                                _G.Fighting["SuperHuman"] = false
                                _G.Setting["Start Farm"] = false
                                _G.SelectChip = "Flame"
                                _G.AutoDungeon = true
                            end
...
spawn(function()
    while wait() do
        if _G.Quest["Second Sea"] then
            _G.Setting["Start Farm"] = false
            pcall(function()
                if game.Players.LocalPlayer.Data.Level.Value >= 700 and World1 then
                    if game.Workspace.Map.Ice.Door.CanCollide == true and game.Workspace.Map.Ice.Door.Transparency == 0 then
                        repeat wait() TP1(CFrame.new(4851.8720703125, 5.6514348983765, 718.47094726563)) until (CFrame.new(4851.8720703125, 5.6514348983765, 718.47094726563).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.Quest["Second Sea"]
                        wait(1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective")
                        EquipWeapon("Key")
                        repeat wait() TP1(CFrame.new(1347.7124, 37.3751602, -1325.6488)) until (CFrame.new(1347.7124, 37.3751602, -1325.6488).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.Quest["Second Sea"]
                        wait(3)
                            ...
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Ice Admiral" and v.Humanoid.Health > 0 then
                                    repeat wait()
                                        ...
                                        v.HumanoidRootPart.Transparency = 1
                                        TP1(v.HumanoidRootPart.CFrame * Pos)
                                    until v.Humanoid.Health <= 0 or not v.Parent or not _G.Quest["Second Sea"]
...
spawn(function()
    pcall(function()
        while wait(.1) do
            if _G.Quest["Evolution Race"] and game.Players.LocalPlayer.Data.Level.Value >= 850 then
                _G.Setting["Start Farm"] = false
                                    ...
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "Zombie [Lv. 950]" then
                                            repeat task.wait()
                                                ...
                                                EvoRace_Magnet = true
                                            until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flower 3") or not v.Parent or v.Humanoid.Health <= 0 or _G.Quest["Evolution Race"] == false
                                            EvoRace_Magnet = false
                                        end
                                    end
                                else
                                    EvoRace_Magnet = false
    ...
    spawn(function()
        while task.wait() do
            if _G.Item["Saber"] and game.Players.LocalPlayer.Data.Level.Value >= 200 then
                _G.Setting["Start Farm"] = false
                pcall(function()
                                                ...
                                                if v.Name == "Mob Leader" then
                                                   if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader") then
                                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                        ...
                                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                                        until v.Humanoid.Health <= 0 or not _G.Item["Saber"]
                                                     end
                                                end
            ...
            for i, v in pairs(game.Workspace.Enemies:GetDescendants()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                    repeat wait(.1)
                        ...
                        v.HumanoidRootPart.CanCollide = false
                        sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                    until not _G.AutoDungeon or not v.Parent or v.Humanoid.Health <= 0
                end
            end
        end
    end
            ...
            if _G.AutoDungeon then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
                        TP1(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*RaidPos)
                    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
                        TP1(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4").CFrame*RaidPos)
                    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") then
                        TP1(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3").CFrame*RaidPos)
                    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
                        TP1(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame*RaidPos)
                    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
                        TP1(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1").CFrame*RaidPos)
                    end
                end
            end
        end
...
while wait(.1) do
    ...
    elseif RaidType == 3 then
        RaidPos = CFrame.new(40,25,0)
    elseif RaidType == 4 then
        RaidPos = CFrame.new(0,25,40)	
    elseif RaidType == 5 then
        RaidPos = CFrame.new(-40,25,0)
    elseif RaidType == 6 then
        RaidPos = CFrame.new(0,25,0)
    end
    end
end)
...
spawn(function()
    while wait() do
        if _G.AutoKatakuri and game.Players.LocalPlayer.Data.Level.Value >= 2550 then
            _G.Setting["Start Farm"] = false
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Dough King") then
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                        TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * Pos)
                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") then
                        TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Dough King").HumanoidRootPart.CFrame * Pos)
                    else
                        if CountMob == 0 then
                        end
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker") then
                                ...
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter") then
                                    TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter").HumanoidRootPart.CFrame * Pos) 
                                else
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard") then
                                        TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard").HumanoidRootPart.CFrame * Pos) 
                                    else
                                        if game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff") then
                                            TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff").HumanoidRootPart.CFrame * Pos)
                                        else
                                            if game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker") then
                                                TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker").HumanoidRootPart.CFrame * Pos)
                                            end
                                        end
                                    end
                                end

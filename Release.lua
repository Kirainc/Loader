...
spawn(function()
    while wait(5) do
        if _G.RedeemCode then
            ...
            if Lv >= _G.Setting["Redeem Code At Level"] - 1 then
...
spawn(function()
	while wait() do
		if _G.Fruit["Buy Fruits"] then
			pcall(function()
				local string_1 = "PurchaseRawFruit";
				local string_2 = _G.Fruit["Select Main Fruits"];
...
spawn(function()
	while wait() do
		if _G.Fruit["Random Fruits"] then
...
spawn(function()
	while wait() do
		if _G.Fruit["Bring Fruits"] then
			pcall(function()
				for i,v in pairs(game.Workspace:GetChildren()) do
					if v:IsA("Tool") and v:FindFirstChild('Handle') then
						if _G.Fruit["Select Fruit Type"] == "Bring Fruits" and _G.Fruit["Bring Fruits"] then 
							firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,v.Handle,0)  
							firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,v.Handle,1)  
						end
						if _G.Fruit["Select Fruit Type"] == "Tween Fruits" and _G.Fruit["Bring Fruits"] then 
							_G.BringFound = true 
							TP1(v.Handle.CFrame)
						end
					end
...
_G.RemoveNotification = true

spawn(function()
	while wait() do
		if _G.RemoveNotification then
...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter or _G.Item["Saber"] or _G.AutoDungeon == true then
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter or _G.Item["Saber"] or _G.AutoDungeon then
...
StopTween(_G.Quest["Bartilo Quest"])

spawn(function()
    while wait(.1) do
        if _G.Quest["Bartilo Quest"] then
            if game.Players.LocalPlayer.Data.Level.Value >= 850 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 0 then
                ...
                if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then 
                    if game:GetService("Workspace").Enemies:FindFirstChild("Swan Pirate") then
                        ...
                        TP1(CFrame.new(1057.92761, 137.614319, 1242.08069))
                    end
                else
                    ...
                    for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == "Jeremy" then
                            repeat task.wait(.1)
                                ...
                                game:GetService'VirtualUser':CaptureController()
                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672),workspace.CurrentCamera.CFrame)
                            until not v.Parent or v.Humanoid.Health <= 0 or _G.Quest["Bartilo Quest"] == false or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
                            _G.FastAttack = false
                        end
                    end
                else
                    if QuestBartilo == 1 then
                        TP1(CFrame.new(1931.5931396484, 402.67391967773, 956.52215576172))
                    end
                end
            elseif game.Players.LocalPlayer.Data.Level.Value >= 850 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
                TP1(game:GetService("Workspace").Map.Dressrosa.BartiloPlates.Plate1.CFrame)
                wait(1)
...
spawn(function()
    while task.wait() do
        if _G.Quest["Third Sea Quest"] then
            pcall(function()
                                        ...
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            if v.Name == "rip_indra" then
                                                repeat task.wait()
                                                    ...
                                                    MonFarm = v.Name
                                                    Click()
                                                until not _G.Quest["Third Sea Quest"] or not v.Parent or v.Humanoid.Health <= 0
                                                _G.FastAttacm = false
                                                wait(.5)
                                                General = 2
                                                ...
                                                if v.Name == "Mob Leader" then
                                                   if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader") then
                                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                        ...
                                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                                        until v.Humanoid.Health <= 0 or not _G.Sword["Saber"]
                                                     end
                                                end

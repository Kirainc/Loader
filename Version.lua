...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter == true then
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        if _G.Setting["Start Farm"] or _G.SkipFarmLevel or _G.Fast_Royal_Squad or _G.Fast_Royal_Soldier or _G.AutoPlayerHunter then
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.FastFarmMode and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 45 then
                    _G.SkipFarmLevel = false
                    _G.Fast_Royal_Squad = true
				end
			end
		end
	end)
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.FastFarmMode and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 58 then
                    _G.Fast_Royal_Squad = false
                    _G.Fast_Royal_Soldier = true
				end
			end
		end
	end)
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.FastFarmMode and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 66 then
                    _G.Fast_Royal_Soldier = false
                    _G.Fast_Royal_Squad = true
				end
			end
		end
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.FastFarmMode and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 68 then
                    _G.Fast_Royal_Squad = false
                    _G.SkipFarmLevel = true
				end
			end
...
StopTween(_G.Fast_Royal_Squad)
spawn(function()
	while wait() do
		if _G.Fast_Royal_Squad and World1 then
			pcall(function()
			if game.Players.LocalPlayer.Data.Level.Value >= 45 then
				TP1(CFrame.new(-7624.25244140625, 5658.13330078125, -1467.354248046875))
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Royal Squad" then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat task.wait()
									...
									game:GetService("VirtualUser"):CaptureController()
									game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
								until not _G.Fast_Royal_Squad or not v.Parent or v.Humanoid.Health <= 0
								RoyalMagnet = false
								TP1(CFrame.new(-7624.25244140625, 5658.13330078125, -1467.354248046875))
							end
						end
					...
					if game:GetService("ReplicatedStorage"):FindFirstChild("Royal Squad") then
						TP1(game:GetService("ReplicatedStorage"):FindFirstChild("Royal Squad").HumanoidRootPart.CFrame * CFrame.new(5,10,2))
					end
				end
			end)
		end
...
StopTween(_G.Fast_Royal_Soldier)

spawn(function()
	while wait() do
		if _G.Fast_Royal_Soldier and World1 then
			pcall(function()
			if game.Players.LocalPlayer.Data.Level.Value >= 58 then
				TP1(CFrame.new(-7624.25244140625, 5658.13330078125, -1467.354248046875))
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Royal Soldier" then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat task.wait()
									...
									game:GetService("VirtualUser"):CaptureController()
									game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
								until not _G.Fast_Royal_Soldier or not v.Parent or v.Humanoid.Health <= 0
								SoldierMagnet = false
								TP1(CFrame.new(-7624.25244140625, 5658.13330078125, -1467.354248046875))
							end
						end
                ...
                for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
                        repeat wait()
                            ...
                            EquipWeapon(_G.SelectWeapon)
                            Click()
                            topos(v.HumanoidRootPart.CFrame * Player_Hunter)								
                            v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                            game:GetService'VirtualUser':CaptureController()
                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
